...
const EditInvoicePage = async ({
  ...
  return (
    <Content>
      ...
      <SalesInvoiceForm mode={credit === "1" ? "CREDIT_INVOICE" : "NEW_INVOICE"} documentType="INVOICE" viewInvoicenumber={invoicenumber} invoiceId={invoicenumber} creditFromMemo={credit === "1"} />
    </Content>
  );
};
