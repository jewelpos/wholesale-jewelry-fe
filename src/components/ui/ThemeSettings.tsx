...
import { setLayoutChange } from "@/lib/store/slice/themeSlice";
        ...
        <div className="sidebar-content sticky-sidebar-one">
          <div className="sidebar-header">
            ...
            <div className="close-sidebar-icon d-flex">
              ...
              <Link className="sidebar-close" href="#" onClick={showSettings}>
                X
              </Link>
            </div>
          </div>
                          ...
                          <div className="d-flex align-items-center">
                            <div className="status-toggle d-flex align-items-center me-2">
                              ...
                              <label htmlFor="rtl" className="checktoggles">
                                <Link
                                  href="https://dreamspos.dreamstechnologies.com/react/template-rtl/"
                                  target="_blank"
                                >
                                  <img
