...
export function makeProductColumnDefs(
  ...
  return [
    ...
    { headerName: "Sell Price",         field: "itemsellprice",      filter: "agNumberColumnFilter", hide: false, cellRenderer: currencyFormattedCellRenderer, headerClass: "ag-right-aligned-header", cellClass: "ag-right-aligned-cell" },
    {
    ...
    { headerName: "Reorder Point",      field: "itemreorderqtypnt",  filter: "agNumberColumnFilter", hide: true },
    { headerName: "Order Quantity",     field: "itemreorderqty",     filter: "agNumberColumnFilter", hide: true },
    ...
    { headerName: "Qty In Hand",        field: "itemquantityinhand", filter: "agNumberColumnFilter", hide: false, cellRenderer: qtyFormattedCellRenderer, headerClass: "ag-right-aligned-header", cellClass: "ag-right-aligned-cell" },
    { headerName: "SO Quantity",        field: "soquantity",         filter: "agNumberColumnFilter", hide: false, cellRenderer: qtyFormattedCellRenderer, headerClass: "ag-right-aligned-header", cellClass: "ag-right-aligned-cell" },
    { headerName: "Available Qty",      field: "availableqty",       filter: "agNumberColumnFilter", hide: false, cellRenderer: qtyFormattedCellRenderer, headerClass: "ag-right-aligned-header", cellClass: "ag-right-aligned-cell" },
    { headerName: "Overall Qty",        field: "overall_qty",        filter: "agNumberColumnFilter", hide: false, cellRenderer: qtyFormattedCellRenderer, headerClass: "ag-right-aligned-header", cellClass: "ag-right-aligned-cell" },
    { headerName: "Memo Qty",           field: "memoqty",            filter: "agNumberColumnFilter", hide: false, cellRenderer: qtyFormattedCellRenderer, headerClass: "ag-right-aligned-header", cellClass: "ag-right-aligned-cell" },
    {
    ...
    { headerName: "Total Cost Value",   field: "totalcostvalue",     filter: "agNumberColumnFilter", hide: true, cellRenderer: currencyFormattedCellRenderer, headerClass: "ag-right-aligned-header", cellClass: "ag-right-aligned-cell" },
    { headerName: "Total Sale Value",   field: "totalsalevalue",     filter: "agNumberColumnFilter", hide: true, cellRenderer: currencyFormattedCellRenderer, headerClass: "ag-right-aligned-header", cellClass: "ag-right-aligned-cell" },
    { headerName: "Average Cost",       field: "itemaveragecost",    filter: "agNumberColumnFilter", hide: true, cellRenderer: currencyFormattedCellRenderer, headerClass: "ag-right-aligned-header", cellClass: "ag-right-aligned-cell" },
