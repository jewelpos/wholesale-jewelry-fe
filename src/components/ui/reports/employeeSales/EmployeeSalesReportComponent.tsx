...
const EmployeeSalesReportComponent = () => {
  ...
  const [getMonthlyEmployeeSalesPivot] = useLazyQuery(
  ...
  const handleOnGridReady = (
    params: GridReadyEvent<EmployeeYearlySalesSummary>
  ) => {
    setGridReady(true);
  ...
  const datasource = useMemo(
        ...
        const result = await handleTryCatch(async () => {
          ...
          if (data.getMonthlyEmployeeSalesPivot) {
            const {
              ...
              total,
              totalsRow,
            } = data.getMonthlyEmployeeSalesPivot;
            params.success({
              rowData: rows,
              rowCount: total,
            });
    ...
    [parsedStoreId, selectedOutlet, dispatch, getMonthlyEmployeeSalesPivot, debouncedSearch]
  );
