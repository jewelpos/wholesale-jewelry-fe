...
const MonthlySalesReportsComponent = () => {
  ...
  const [getMonthlySalesPivot] = useLazyQuery(
  ...
  const handleOnGridReady = (
    params: GridReadyEvent<WarehouseYearlySummary>
  ) => {
    setGridReady(true);
  ...
  const datasource = useMemo(
    ...
    [parsedStoreId, selectedOutlet, dispatch, getMonthlySalesPivot, debouncedSearch]
  );
