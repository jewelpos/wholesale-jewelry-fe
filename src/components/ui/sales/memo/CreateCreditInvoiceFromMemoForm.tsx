...
const CreateCreditInvoiceFromMemoForm = () => {
      ...
      ? [
          {
            ...
            value: {
              ...
              operator: "OR",
              conditions: [
                { filterType: "text", type: "contains", filter: debouncedMemoSearch },
              ],
            },
          },
        ]
      ...
      <div className="card">
        <div className="card-body">
          <div className="alert alert-warning" role="alert" style={{ marginBottom: 16 }}>
            <strong>Credit Invoice from Memo</strong> — all item quantities will be recorded as
            negative (return). Inventory will be credited back to stock.
          </div>
          <div className="row">
...
export default CreateCreditInvoiceFromMemoForm;
