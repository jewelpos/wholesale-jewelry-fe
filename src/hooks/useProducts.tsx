...
import { GET_ALL_INVENTORY_ITEMS_QUERY } from "@/lib/graphql/query/product";
...
const useProducts = () => {
    ...
    const result = await handleTryCatch(
      async () => {
        ...
        if (data?.getAllInventoryItems) {
          setProducts(data.getAllInventoryItems as Item[]);
        }
        return true;
      },
      () => {
  ...
  return { products, loading, fetchProductsByStoreId };
};
