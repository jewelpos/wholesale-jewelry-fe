...
query GetSupplierBalanceDue($storeid: Int!, $outletid: Int, $supplierid: Int!, $includeClosed: Boolean) {
  getSupplierBalanceDue(storeid: $storeid, outletid: $outletid, supplierid: $supplierid, includeClosed: $includeClosed) {
    supplierinvoiceid
    supplierid
    veninvoiceno
    veninvoicedate
